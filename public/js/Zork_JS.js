	...
	switch(currentLocation){
		...
		case "house":
			...
			if(response=="go inside"){
				alert(winMessage);
				 currentLocation = "insideHouse";//to end game
			}else if(response=="go south"){
				currentLocation = "pond";	
			}else if(response=="go east"){
				currentLocation = "forest";
			}else if(response=="go west" || "go north"){
				alert('Forbidden!');
			}
				break;
		case "clearing":
			...
			if(response=="go north"){
				...
				currentLocation = "pond";
			}else if(response=="go south" || "go east"){
				alert('Forbidden!');
			}
				break;
		case "pond":
				alert(pondMessage);
				response = prompt('yes or no? Would you like some water before moving on?');
			if(response=="yes"){
					alert("Sorry. You died. Game Over!");
					currentLocation=winDestination;//to end game
